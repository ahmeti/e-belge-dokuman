...
<xsl:stylesheet version="2.0" 
				...
				<xsl:for-each select="$XML">
					...
					<table border="1" id="lineTable" width="800">
						<tbody>
							...
							<xsl:if test="count(//n1:ReceiptAdvice/cac:ReceiptLine) &gt;= 20">
							...
							<xsl:if test="count(//n1:ReceiptAdvice/cac:ReceiptLine) &lt; 20">
								<xsl:choose>
									<xsl:when test="//n1:ReceiptAdvice/cac:ReceiptLine[1]">
										<xsl:apply-templates
											select="//n1:ReceiptAdvice/cac:ReceiptLine[1]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:ReceiptAdvice"/>
									</xsl:otherwise>
								</xsl:choose>
								<xsl:choose>
									<xsl:when test="//n1:ReceiptAdvice/cac:ReceiptLine[2]">
										<xsl:apply-templates
											select="//n1:ReceiptAdvice/cac:ReceiptLine[2]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:ReceiptAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:ReceiptAdvice/cac:ReceiptLine[3]">
										<xsl:apply-templates
											select="//n1:ReceiptAdvice/cac:ReceiptLine[3]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:ReceiptAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:ReceiptAdvice/cac:ReceiptLine[4]">
										<xsl:apply-templates
											select="//n1:ReceiptAdvice/cac:ReceiptLine[4]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:ReceiptAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:ReceiptAdvice/cac:ReceiptLine[5]">
										<xsl:apply-templates
											select="//n1:ReceiptAdvice/cac:ReceiptLine[5]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:ReceiptAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:ReceiptAdvice/cac:ReceiptLine[6]">
										<xsl:apply-templates
											select="//n1:ReceiptAdvice/cac:ReceiptLine[6]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:ReceiptAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:ReceiptAdvice/cac:ReceiptLine[7]">
										<xsl:apply-templates
											select="//n1:ReceiptAdvice/cac:ReceiptLine[7]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:ReceiptAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:ReceiptAdvice/cac:ReceiptLine[8]">
										<xsl:apply-templates
											select="//n1:ReceiptAdvice/cac:ReceiptLine[8]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:ReceiptAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:ReceiptAdvice/cac:ReceiptLine[9]">
										<xsl:apply-templates
											select="//n1:ReceiptAdvice/cac:ReceiptLine[9]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:ReceiptAdvice"/>
									</xsl:otherwise>
								...
								<xsl:choose>
									<xsl:when test="//n1:ReceiptAdvice/cac:ReceiptLine[10]">
										<xsl:apply-templates
											select="//n1:ReceiptAdvice/cac:ReceiptLine[10]"/>
									</xsl:when>
									<xsl:otherwise>
										<xsl:apply-templates select="//n1:ReceiptAdvice"/>
									</xsl:otherwise>
	...
	<xsl:template match="//n1:ReceiptAdvice/cac:ReceiptLine">
		<tr class="lineTableTr">
			...
			<td class="lineTableTd">
				<xsl:text>&#160;</xsl:text>
				<xsl:value-of select="./cbc:Note"/><xsl:text>&#160;</xsl:text><xsl:value-of select="./cbc:RejectReason"/>
			</td>
		</tr>
	</xsl:template>
